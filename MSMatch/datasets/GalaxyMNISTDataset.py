...
class GalaxyMNIST(MNIST):
    ...
    resources = [
        (
            "https://dl.dropboxusercontent.com/s/5a14de0o7slyif9/train_dataset.hdf5.gz",
            "e408ae294e9b975482dc1abffeb373a6",
        ),
        (
            "https://dl.dropboxusercontent.com/s/5rza12nn24cwd2k/test_dataset.hdf5.gz",
            "7a940e4cea64a8b7cb60339098f74490",
        ),
    ]
    ...
    def load_custom_data(self, test_size=0.2, stratify=False, random_state=42):
        ...
        if stratify:
            split_indices = model_selection.StratifiedShuffleSplit(
                n_splits=1, test_size=test_size, random_state=random_state
            ).split(X=all_images, y=all_labels)
            ...
            train_images, train_labels, test_images, test_labels = model_selection.train_test_split(
...
class GalaxyMNISTHighrez(GalaxyMNIST):
    resources = [
        (
            "https://dl.dropboxusercontent.com/s/xenuo0ekgyi10ru/train_dataset.hdf5.gz",
            "3391dcddac14d5b4055db73fb600ae63",
        ),
        (
            "https://dl.dropboxusercontent.com/s/lczri4sb4bbcgyh/test_dataset.hdf5.gz",
            "fb272c4e94000b4d99a09d638977b0b9",
        ),
    ]
...
def read_dataset_file(path: str) -> torch.Tensor:
    ...
    with h5py.File(path, "r") as f:
        ...
        targets = torch.from_numpy(targets).type(
            torch.int64
        )  # dtype consistent with mnist (same as tensor.long())
