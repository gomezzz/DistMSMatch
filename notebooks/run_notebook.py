...
def main(): 
    ...
    parser.add_argument('--results_folder', type=str, help="Path to the results folder.", default="saved_models/test")
    pargs=parser.parse_args()

    result = pm.execute_notebook(
        input_path=pargs.notebook_path,
        output_path="/dev/null",
        parameters={"cfg_path" : pargs.cfg_path, "dataset" : pargs.dataset, "results_folder" : pargs.results_folder},
