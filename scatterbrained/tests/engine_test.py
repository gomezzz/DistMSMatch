...
@pytest.fixture
def id1():
    return Identity(id="1", namespace="foo", host="127.0.0.1", port=9002, metadata={})


@pytest.fixture
def id2():
    return Identity(id="2", namespace="bar", host="127.0.0.1", port=9002, metadata={})


@pytest.fixture
def id3():
    return Identity(id="3", namespace="baz", host="127.0.0.1", port=9003, metadata={})
...
async def test_NetworkEngine_send_to(id1, id2):
    ...
    await tx.send.awaited_once_with(orjson.dumps(attrs.asdict(id1)), b"hello there")
